...
var default_1 = /** @class */ (function () {
    function default_1(server) {
        ...
        pm2_1.default.launchBus(function (error, bus) {
            if (error) {
                return _this.server.send(_1.WSEvents.PM2Error, {
            ...
            bus.on("process:event", function (packet) {
                ...
                _this.server.send(_1.WSEvents.LogData, {
                    timestamp: packet.at,
                    type: "process_event",
                    status: packet.event,
    ...
    default_1.prototype.run = function (data) {
        var command = data.command, input = __rest(data, ["command"]);
        switch (command) {
            case _1.Commands.GetProcesses:
                this.getProcesses();
                break;
            case _1.Commands.StartLogs:
                this.startLogs();
                break;
            case _1.Commands.StopLogs:
                this.stopLogs();
                break;
            case _1.Commands.StartProcess:
                this.startProcess(input);
                break;
            case _1.Commands.StopProcess:
                this.stopProcess(input);
                break;
            case _1.Commands.RestartProcess:
                this.restartProcess(input);
                break;
            default:
                this.server.send(_1.WSEvents.InvalidCommand, {
    ...
    default_1.prototype.getProcesses = function () {
        ...
        pm2_1.default.list(function (error, processDescriptionList) {
            ...
            _this.server.send(_1.WSEvents.ProcessesList, { processes: processes });
        });
    };
